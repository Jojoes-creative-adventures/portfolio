...
document.addEventListener('scroll', () => {
  ...
  scrollTimeout = setTimeout(() => {
    ...
    bringImageToFront("#imgGrenouille", "#grenouille", ".text");
    bringImageToFront("#imgIvan", "#ivan", ".text");
    bringImageToFront("#imgBabayaga", "#babayaga", ".text");
    bringImageToFront("#imgPage", "#page", ".text");
