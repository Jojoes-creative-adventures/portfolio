...
document.addEventListener('scroll', () => {
  ...
  scrollTimeout = setTimeout(() => {
    ...
    bringImageToFront("#imgHomepage", "#homepage", ".text");
    bringImageToFront("#imgProducts", "#products", ".text");
    bringImageToFront("#imgAbout", "#about", ".text");
    bringImageToFront("#imgWelcome", "#welcome", ".text");
