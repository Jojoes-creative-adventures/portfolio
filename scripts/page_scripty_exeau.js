...
document.addEventListener('scroll', () => {
  ...
  scrollTimeout = setTimeout(() => {
    ...
    bringImageToFront("#imgCover", "#cover", ".text");
    bringImageToFront("#imgIso", "#iso", ".text");
    bringImageToFront("#imgCartographie", "#cartographie", ".text");
    bringImageToFront("#imgEval", "#eval", ".text");
    bringImageToFront("#imgBilan", "#bilan", ".text");
