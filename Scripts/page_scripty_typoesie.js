...
document.addEventListener('scroll', () => {
  ...
  scrollTimeout = setTimeout(() => {
    ...
    function bringImageToFront(imageId, triggerId, scrollerId) {
      gsap.to(imageId, {
        ...
        scrollTrigger: {
          ...
          start: "top 30%", // Trigger when the element reaches the center of the viewport
    ...
    bringImageToFront("#imgIntro", "#intro", ".text");
      bringImageToFront("#imgCouvAvant", "#couvAvant", ".text");
      bringImageToFront("#imgGalette", "#galette", ".text");
      bringImageToFront("#imgCouvArriere", "#couvArriere", ".text");
            ...
            function toggleProjectInfo() {
                if (!isExpanded) {
                    ...
                    if (document.documentElement.lang === "fr") {
                      ...
                      learnMoreButton.querySelector("h5").innerText = "See more";
                    }
